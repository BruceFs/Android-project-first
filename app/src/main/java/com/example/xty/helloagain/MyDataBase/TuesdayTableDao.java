...
/**
 * DAO for table "TUESDAY_TABLE".
*/
public class TuesdayTableDao extends AbstractDao<TuesdayTable, Long> {

    public static final String TABLENAME = "TUESDAY_TABLE";

    /**
     * Properties of entity TuesdayTable.<br/>
    ...
    */
    ...
    public TuesdayTableDao(DaoConfig config) {
        super(config);
    }
    
    public TuesdayTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TUESDAY_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TUESDAY_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TuesdayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TuesdayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public TuesdayTable readEntity(Cursor cursor, int offset) {
        TuesdayTable entity = new TuesdayTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, TuesdayTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TuesdayTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TuesdayTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
