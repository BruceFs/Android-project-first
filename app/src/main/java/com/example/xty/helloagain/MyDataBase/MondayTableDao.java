...
/**
 * DAO for table "MONDAY_TABLE".
*/
public class MondayTableDao extends AbstractDao<MondayTable, Long> {

    public static final String TABLENAME = "MONDAY_TABLE";

    /**
     * Properties of entity MondayTable.<br/>
    ...
    */
    ...
    public MondayTableDao(DaoConfig config) {
        super(config);
    }
    
    public MondayTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MONDAY_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MONDAY_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MondayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MondayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public MondayTable readEntity(Cursor cursor, int offset) {
        MondayTable entity = new MondayTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, MondayTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MondayTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MondayTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
