...
/**
 * DAO for table "FRIDAY_TABLE".
*/
public class FridayTableDao extends AbstractDao<FridayTable, Long> {

    public static final String TABLENAME = "FRIDAY_TABLE";

    /**
     * Properties of entity FridayTable.<br/>
    ...
    */
    ...
    public FridayTableDao(DaoConfig config) {
        super(config);
    }
    
    public FridayTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FRIDAY_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FRIDAY_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FridayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FridayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public FridayTable readEntity(Cursor cursor, int offset) {
        FridayTable entity = new FridayTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, FridayTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(FridayTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FridayTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
