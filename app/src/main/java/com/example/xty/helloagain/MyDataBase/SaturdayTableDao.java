...
/**
 * DAO for table "SATURDAY_TABLE".
*/
public class SaturdayTableDao extends AbstractDao<SaturdayTable, Long> {

    public static final String TABLENAME = "SATURDAY_TABLE";

    /**
     * Properties of entity SaturdayTable.<br/>
    ...
    */
    ...
    public SaturdayTableDao(DaoConfig config) {
        super(config);
    }
    
    public SaturdayTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SATURDAY_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SATURDAY_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SaturdayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SaturdayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public SaturdayTable readEntity(Cursor cursor, int offset) {
        SaturdayTable entity = new SaturdayTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, SaturdayTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SaturdayTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SaturdayTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
