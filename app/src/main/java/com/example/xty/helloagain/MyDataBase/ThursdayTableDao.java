...
/**
 * DAO for table "THURSDAY_TABLE".
*/
public class ThursdayTableDao extends AbstractDao<ThursdayTable, Long> {

    public static final String TABLENAME = "THURSDAY_TABLE";

    /**
     * Properties of entity ThursdayTable.<br/>
    ...
    */
    ...
    public ThursdayTableDao(DaoConfig config) {
        super(config);
    }
    
    public ThursdayTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"THURSDAY_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"THURSDAY_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ThursdayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ThursdayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public ThursdayTable readEntity(Cursor cursor, int offset) {
        ThursdayTable entity = new ThursdayTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, ThursdayTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ThursdayTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ThursdayTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
