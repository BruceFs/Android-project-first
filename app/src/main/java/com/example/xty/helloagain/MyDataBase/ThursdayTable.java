...
public class ThursdayTable {
    ...
    @Generated(hash = 1697288622)
    public ThursdayTable(Long id, int weekNumber, String firstClass,
    ...
    @Generated(hash = 1059076310)
    public ThursdayTable() {
    }
