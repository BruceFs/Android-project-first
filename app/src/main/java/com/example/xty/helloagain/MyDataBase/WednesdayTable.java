...
public class WednesdayTable {
    ...
    @Generated(hash = 505995293)
    public WednesdayTable(Long id, int weekNumber, String firstClass,
    ...
    @Generated(hash = 387481532)
    public WednesdayTable() {
    }
