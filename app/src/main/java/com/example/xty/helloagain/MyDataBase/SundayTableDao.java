...
/**
 * DAO for table "SUNDAY_TABLE".
*/
public class SundayTableDao extends AbstractDao<SundayTable, Long> {

    public static final String TABLENAME = "SUNDAY_TABLE";

    /**
     * Properties of entity SundayTable.<br/>
    ...
    */
    ...
    public SundayTableDao(DaoConfig config) {
        super(config);
    }
    
    public SundayTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SUNDAY_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SUNDAY_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SundayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SundayTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public SundayTable readEntity(Cursor cursor, int offset) {
        SundayTable entity = new SundayTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, SundayTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SundayTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SundayTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
